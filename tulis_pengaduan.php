      ...
      <div class="card-body">
          <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
              <div class="form-group cols-sm-6">
                  <input type="text" name="tgl_pengaduan" value="<?php echo date('d/m/Y'); ?>" class="form-control" readonly hidden>
              </div>
              <div class="form-group cols-sm-6">
                  <input type="text" name="nik" value="<?php echo $_SESSION['nik']; ?>" class="form-control" readonly hidden>
              </div>
               <div class="form-group cols-sm-6">
              ...
              <div class="form-group cols-sm-6">
                  ...
                  <textarea class="form-control" name="isi_laporan" rows="6"></textarea>
              </div>
